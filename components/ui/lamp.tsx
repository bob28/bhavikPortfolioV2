...
const colorMap: Record<string, { 400: string; 500: string }> = {
  green: { 400: "#4ade80", 500: "#22c55e" },
  red: { 400: "#fb2c36", 500: "#e7000b" },
    ...
    >
      <div className="relative flex w-full flex-1  items-center justify-center isolate z-0 mt-72">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 70deg at center top, ${colorMap[color]?.["500"] || colorMap.green["500"]}, transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(from 290deg at center top, transparent, transparent, ${colorMap[color]?.["500"] || colorMap.green["500"]})`,
          }}
        ...
        <div
          ...
          style={{
            backgroundColor: colorMap[color]?.["500"] || colorMap.green["500"],
          }}
        ></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          style={{
            backgroundColor: colorMap[color]?.["400"] || colorMap.green["400"],
          }}
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
